...
# Fix the f-string syntax by properly escaping braces
def escape_fstring_braces(text):
    """Escape braces in text for f-string compatibility"""
...
def main():
    ...
    print("  - Statistics page: public/facilities/statistics.html")
